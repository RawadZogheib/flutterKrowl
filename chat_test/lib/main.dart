...
import 'package:chat_test/api/my_api.dart';
import 'package:flutter/material.dart';
import 'package:stream_chat/stream_chat.dart';
import 'package:chat_test/globals/globals.dart' as globals;
Future<void> main() async {

  const apiKey = "swtmb3ttxxsq";
  const userToken = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoiJy4uJyJ9.2hMFQFYBNjbljVUVtSISM4GlDf93o_HRpiBpyeWKRIA"; //should be sent by the server
