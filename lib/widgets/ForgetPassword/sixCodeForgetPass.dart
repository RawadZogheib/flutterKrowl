...
import 'package:Krowl/widgets/ForgetPassword/myErrorText.dart';
import 'package:flutter/material.dart';
import 'package:Krowl/api/my_api.dart';
import 'package:Krowl/globals/globals.dart' as globals;
import 'package:Krowl/widgets/Buttons/myButton.dart';
import 'package:Krowl/widgets/Code/myCode.dart';
...
class _sixCodeForgetPassState extends State<sixCodeForgetPass> {
  ...
  _checkCode() async {
    ...
    try {
      ...
      var res = await CallApi()
          .postData(data, '(Control)checkCodeForgetPass.php');
      //print(res);
      print(res.body);
      List<dynamic> body = json.decode(res.body);

      if (body[0] == "success") {
        Navigator.pushNamedAndRemoveUntil(context, '/forgetPass2', (route) =>  false);
  ...
  _resendCode() async {
    ...
    var res = await CallApi()
        .postData(data, '/(Control)postmark.php');
    print(res);
    //print("pppppp");
    List<dynamic> body = json.decode(res.body);
    print(res.body);
