...
class _ChatDetailPageState extends State<ChatDetailPage> {
  ...
  List<SendMenuItems> menuItems = [
    SendMenuItems(text: "Photos & Videos", icons: Icons.image),
    SendMenuItems(text: "Document", icons: Icons.insert_drive_file),
    SendMenuItems(text: "Audio", icons: Icons.music_note),
    SendMenuItems(text: "Contact", icons: Icons.person),
  ];
                      ...
                      return Container(
                        ...
                        child: ListTile(
                          leading: Container(
                            ...
                            height: 50,
                            width: 50,
                            child: Icon(menuItems[index].icons,size: 20,color: globals.blue1,),
                          ),
