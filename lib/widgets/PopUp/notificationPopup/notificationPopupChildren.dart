                        ...
                        child: Row(
                          children: [
                            widget.notification_type==41?Row(
                              children: [
                                myBtn2(btnText: Text("Confirm"),height:20,width:85,onPress: () { _confirmRequest();},color1:globals.blue1,color2: Colors.white),
                                Padding(
                                  padding: const EdgeInsets.only(left:8.0),
                                  child: myBtn2(btnText: Text("Cancel"),height:20,width:75,onPress: () { _cancelRequest();},color1:Colors.white,color2: globals.blue1),
                                ),
                              ],
                            )
                            : Icon(
