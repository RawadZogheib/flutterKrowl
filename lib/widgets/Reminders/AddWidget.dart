...
class AddWidget1 extends StatefulWidget {
  ...
  @override
  State<AddWidget1> createState() => _AddWidget1State();
}

class _AddWidget1State extends State<AddWidget1> {
...
class AddWidget2 extends StatefulWidget {
  bool _addBool = false;
  ...
  @override
  State<AddWidget2> createState() => _AddWidget2State();
}

class _AddWidget2State extends State<AddWidget2> {
  String? _dropdownValue;
  List gender = [
    'every',
    'in',
