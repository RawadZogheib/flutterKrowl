                          ...
                          child: Stack(children: [
                            DefaultTextStyle(
                              ...
                              child: AnimatedTextKit(
                                totalRepeatCount: 3,
                                animatedTexts: [
                                  TyperAnimatedText('Reminders', textStyle: TextStyle(color: Colors.black, fontWeight: FontWeight.w700)),
                                ],
                                onTap: () {
                                  print("Tap Event");
                                },
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        add == false?  Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(height: 15),
                                              Text("When do you want to receive this reminder ? *",
                                                style:
                                                GoogleFonts.nunito(fontSize: 16, color: Colors.black),
                                              ),
                                              SizedBox(height: 10),
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: ElevatedButton(onPressed: (){
                                                      ...
                                                      child: Text ("Create",
                                                        style: TextStyle(fontSize: 17, fontFamily: 'Rubik', color: Colors.white),
                                        ...
                                        if(Enabled)
                                          Column(
                                            children: [
                                              ReminderWidget(ReminderContent: "Something very important"),
                                              ReminderWidget(ReminderContent: "HELOOOOOOO")
                                            ],
                                          ),
                                        if(!Enabled)
                                          Text("You don't have any enabled reminders. Create one by clicking on the add button above, or check your disabled reminders.",
                                            style: GoogleFonts.nunito(
                                                fontSize: 17,
